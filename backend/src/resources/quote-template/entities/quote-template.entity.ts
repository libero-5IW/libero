...
import { QuoteTemplateVariableEntity } from './quote-template-variable.entity'; // à adapter selon ton arborescence
...
export class QuoteTemplateEntity {
  ...
  @ApiProperty({ example: 'Modèle de devis pour site vitrine' })
  @Expose()
  name: string;

  @ApiProperty({
    example:
      '<p>Bonjour {{client_name}}, voici votre devis pour {{prestation}}...</p>',
  })
  @Expose()
  contentHtml: string;
