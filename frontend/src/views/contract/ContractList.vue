<template>
  <div class="ml-4 mt-8 focus:outline-none" role="main" aria-labelledby="contract-page-title" tabindex="-1" ref="mainContent">
    <div class="flex items-center justify-between mb-10">
      <h1 id="contract-page-title" class="text-xl font-bold">Liste des contrats</h1>
      <v-btn color="primary" @click="showTemplateModal = true"  aria-label="Créer un nouveau contrat">
